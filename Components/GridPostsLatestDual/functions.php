...
namespace Flynt\Components\GridPostsLatestDual;
...
add_filter('Flynt/addComponentData?name=GridPostsLatestDual', function ($data) {
    $postType = POST_TYPE;
...
{
    return [
        'name' => 'GridPostsLatestDual',
        'label' => 'Grid: Posts Latest (Two Columns)',
        'sub_fields' => [
            [
                'label' => 'General',
                'name' => 'generalTab',
            ...
            [
                'label' => 'Coloumn 1 Categories',
                'name' => 'taxonomiesColOne',
                'type' => 'taxonomy',
            ...
            [
                'label' => 'Column 2 Categories',
                'name' => 'taxonomiesColTwo',
                'type' => 'taxonomy',
                'instructions' => 'Select 1 or more categories or leave empty to show from all posts.',
                'taxonomy' => 'category',
                'field_type' => 'multi_select',
